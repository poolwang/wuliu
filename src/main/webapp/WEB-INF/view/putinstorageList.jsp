...
$(function(){
	$('#orderTable').bootstrapTable({
		url: 'putinstorage/list.do',//ajax请求的url地址
...
function operationFormatter(value,row,index){
		var html = "<a href='putinstorage/returnMsg.do?orderId="+row.orderId+"'><span class='glyphicon glyphicon-circle-arrow-right' style='cursor: pointer;'title='核对入库'></span></a>";
		return html;			
}
