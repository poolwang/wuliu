...
<div class="page-container">
	...
	<h4 align="center">未进行财务审核的订单列表</h4>
	
	<!-- 定义一个表格，以供bootstrap-table插件使用 -->
	<table id="financeTable" class="table table-border table-bordered table-bg">
	</table>
...
$(function(){
	$('#financeTable').bootstrapTable({
		url: 'finance/list.do',//ajax请求的url地址
...
function operationFormatter(value,row,index){
	var html = "<a href='finance/returnMsg.do?orderId="+row.orderId+"'><span class='glyphicon glyphicon-circle-arrow-right' style='cursor: pointer;'title='财务审核'></span></a>";
		return html;			
}
...
function refreshTable(){
	$('#financeTable').bootstrapTable('refresh');
}
</script>
</body>
</html>